...
int main(void) {
    ...
    hSensor1 = pcvsensorInit(I2CBus2, 0x40);
    hSensor2 = pcvsensorInit(I2CBus2, 0x44);
    ...
    while (1)
    {
        ...
        debugPrintF("Bus #1: %.3f V, Shunt #1: %.3f, Current #1: %.4f; Bus #2: %.3f V, Shunt #2: %.3f, Current #2: %.4f\r\n",
                    pdata1->busVoltageV, pdata1->shuntVoltageV, calcdcurrentA1,
                    pdata2->busVoltageV, pdata2->shuntVoltageV, calcdcurrentA2);
    }
