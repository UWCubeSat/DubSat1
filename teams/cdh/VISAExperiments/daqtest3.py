...
if __name__ == '__main__':
    multipleAI = MultiChannelAnalogInput(["Dev1/ai2", "Dev1/ai1", "Dev1/ai0"])
    multipleAI.configure()

    while True:
        data0 = multipleAI.read("Dev1/ai0")
        data1 = multipleAI.read("Dev1/ai1")
        data2 = multipleAI.read("Dev1/ai2")
        print("Data = '%f/%f/%f'" % (data0, data1, data2))